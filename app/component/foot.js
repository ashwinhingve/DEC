          ...
          <div className="footer-content container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="footer-section m-4 md:ml-5 lg:ml-10">
              ...
              <p className='my-2'>
                ...
                top-notch services and products to our clients worldwide.
              </p>
              <p className='my-2'>
            ...
            {/* Newsletter Section */}
            <div className="footer-section newsletter m-4 md:mr-5 lg:mr-10">
              ...
              <div className="mt-4">
                <input
                  ...
                  className="p-2 rounded-md w-full border border-gray-700 bg-gray-800 text-white"
                  required
                />
                <button
                  type="submit"
                  className="mt-2 w-full p-2 bg-blue-600 hover:bg-blue-700 rounded-md text-white font-semibold"
                >
                  Subscribe
                </button>
              </div>
